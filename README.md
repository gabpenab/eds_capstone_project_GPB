...
Data Sources - occurrence: GBIF
               Environmental data: Climate from Worldclim or CHELSA-EarthEnv
                                   land cover from MODIS
                                   elevation and water bodies from NASA Earthdata (SRTM)
                                   cave location DarkCide 1.0
                                   Future climate projections: Available CMIP6 in Climate Data Store from Copernicus

Requirements – R: ggplot 2, dplyr
